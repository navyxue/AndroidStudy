...
import com.quxianggif.network.model.GetFollowers
...
/**
 * 获取指定用户所有粉丝列表的请求。对应服务器接口：/user/followers
 *
 * @author guolin
 * @since 17/7/27
 */
class GetFollowersRequest : Request() {

    private var userId: Long = 0

    private var page: Int = 0

    fun userId(userId: Long): GetFollowersRequest {
        this.userId = userId
        return this
    }

    fun page(page: Int): GetFollowersRequest {
        this.page = page
        return this
    }
    ...
    override fun listen(callback: Callback?) {
        ...
        inFlight(GetFollowers::class.java)
    }
    ...
    companion object {
        ...
        private val URL = GifFun.BASE_URL + "/user/followers"
    }
